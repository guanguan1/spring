...
public class NIOServerReactor {
    ...
    abstract class ReactorThread extends Thread{
        Selector selector;
        LinkedBlockingQueue<Runnable> taskQuery = new LinkedBlockingQueue<>();

        /**
         * selector监听时间后，调用这个方法
         */
        ...
        public void run() {
            while (running){
                try {
                    Runnable task;
                    while ((task = taskQuery.poll()) != null){
                        task.run();
                    }
    ...
    private void initAndRegister() throws IOException, ExecutionException, InterruptedException {
        ...
        // 2、将servereSocketChannel注册到selector
    ...
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        NIOServerReactor nioServerV3 = new NIOServerReactor();
